...
export function NotFound() {
  return (
    <div className="flex min-h-[100dvh] w-full flex-col items-center justify-center gap-4 bg-void px-6 text-center">
      <img src="/logo-white.png" alt="up.meme" className="h-14 w-14 object-contain opacity-80" />
      <p className="text-[15px] font-bold text-ink">this page went up without you.</p>
